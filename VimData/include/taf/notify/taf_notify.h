...
public:
     ...
     * @return int
     */
	int setNotifyInfo(const CommunicatorPtr &comm, const string &obj, const string & app, const string &serverName, const string &sSetName="", const string &sContainer="");
