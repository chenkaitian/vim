...
/* DataHead 类实现                                                      */
/************************************************************************/
DataHead::DataHead(UInt8 type, UInt8 tag) : _type(type), 
                                                _tag(tag)
{
    // No implementation required
}
...
EXPORT_C DataHead* DataHead::NewLC(UInt8 type, UInt8 tag)
{
...
EXPORT_C DataHead* DataHead::NewL(UInt8 type, UInt8 tag)
{
...
EXPORT_C UInt8 DataHead::getTag() const        
{ 
    return _tag; 
}

EXPORT_C void DataHead::setTag(UInt8 t)    
{ 
    _tag = t; 
}

EXPORT_C UInt8 DataHead::getType() const       
{ 
    return _type; 
}

EXPORT_C void DataHead::setType(UInt8 t)       
{ 
    _type = t; 
}
...
EXPORT_C void JceInputStream::errorRequire(UInt8 tag)
{
    String sTag;   
    sTag.ToString(tag);
...
EXPORT_C bool JceInputStream::skipToTag(UInt8 tag)
{
    ...
    while(true)
    {
        ...
        if(tag <= dataHead->getTag() || dataHead->getType() == DataHead::eStructEnd)
        {
            ...
            UInt8 findType    = dataHead->getType();
            CleanupStack::PopAndDestroy(dataHead);
...
EXPORT_C void JceInputStream::skipField(UInt8 type)
{
    switch(type){
    case DataHead::eChar:
...
EXPORT_C void JceInputStream::read(UInt8& c, UInt8 tag, bool isRequire )
{
    Short i = c;
...
EXPORT_C void JceInputStream::read(UInt16& n, UInt8 tag, bool isRequire )
{
    Int32 i = n;
    read(i,tag,isRequire);
    n = (UInt16)i;
...
EXPORT_C void JceInputStream::read(UInt32& n, UInt8 tag, bool isRequire )
{   
    Int64 i = n;
    read(i,tag,isRequire);
    n = (UInt32)i;
...
EXPORT_C void JceInputStream::read(Bool& b, UInt8 tag, bool isRequire)
{
    Char c = b;
...
EXPORT_C void JceInputStream::read(Char& c, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C void JceInputStream::read(Short& n, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C void JceInputStream::read(Int32& n, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C void JceInputStream::read(Int64& n, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C void JceInputStream::read(Float& n, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C void JceInputStream::read(Double& n, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C void JceInputStream::read(String& s, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C void JceInputStream::read(JceStructBase& v, UInt8 tag, bool isRequire)
{
    if(skipToTag(tag))
    {
        DataHead* dataHead = DataHead::NewL();
...
EXPORT_C bool JceInputStream::readVectorChar(UInt8 tag, Int32 &size)
{
    DataHead* dataHead = DataHead::NewL();
    CleanupStack::PushL(dataHead);
...
EXPORT_C bool JceInputStream::readVector(UInt8 tag, Int32 &size)
{
    DataHead* dataHead = DataHead::NewL();
    CleanupStack::PushL(dataHead);
...
EXPORT_C bool JceInputStream::readMap(UInt8 tag, Int32 &size)
{
    DataHead* dataHead = DataHead::NewL();
    CleanupStack::PushL(dataHead);
...
EXPORT_C void JceOutputStream::write(Bool b, UInt8 tag)
{
    Char c = (Char) (b ? 1 : 0);
    write(c, tag);
}

EXPORT_C void JceOutputStream::write(Char n, UInt8 tag)
{
...
EXPORT_C void JceOutputStream::write(Short n, UInt8 tag)
{
...
EXPORT_C void JceOutputStream::write(Int32 n, UInt8 tag)
{
...
//add by edwardsu
EXPORT_C void JceOutputStream::write(UInt8 n, UInt8 tag)
{    
    write((Short)n,tag);
}
EXPORT_C void JceOutputStream::write(UInt16 n, UInt8 tag)
{
    write((Int32)n,tag);
}
EXPORT_C void JceOutputStream::write(UInt32 n, UInt8 tag)
{
    write((Int64)n,tag);
}
//end add

EXPORT_C void JceOutputStream::write(Int64 n, UInt8 tag)
{
...
EXPORT_C void JceOutputStream::write(Float n, UInt8 tag)
{
...
EXPORT_C void JceOutputStream::write(Double n, UInt8 tag)
{
...
EXPORT_C void JceOutputStream::write(const String& s, UInt8 tag)
{
...
EXPORT_C void JceOutputStream::write(const JceStructBase& v, UInt8 tag)
{
...
EXPORT_C void JceOutputStream::writeHead(UInt8 type, UInt8 tag)
{
