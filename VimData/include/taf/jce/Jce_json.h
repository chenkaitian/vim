#ifndef __JCEJSON_H__
#define __JCEJSON_H__
...
public:
    ...
    template<typename T>
    static void readJson(T& v, const JsonValuePtr & p, bool isRequire = true, typename jce::disable_if<jce::is_convertible<T*, JceStructBase*>, void ***>::type dummy = 0)
    {
        Int32 n = 0;
    ...
    /// 读取结构
    template<typename T>
    static void readJson(T& v, const JsonValuePtr & p, bool isRequire = true, typename jce::enable_if<jce::is_convertible<T*, JceStructBase*>, void ***>::type dummy = 0)
    {
        if(NULL != p.get() && p->getType() == eJsonTypeObj)
        {
            JsonValueObjPtr pObj=JsonValueObjPtr::dynamicCast(p);
...
public:
    ...
    template<typename T>
    static JsonValueNumPtr writeJson(const T& v, typename jce::disable_if<jce::is_convertible<T*, JceStructBase*>, void ***>::type dummy = 0)
    {
        return writeJson((Int32) v);
    }

    template<typename T>
    static JsonValueObjPtr writeJson(const T& v, typename jce::enable_if<jce::is_convertible<T*, JceStructBase*>, void ***>::type dummy = 0)
    {
