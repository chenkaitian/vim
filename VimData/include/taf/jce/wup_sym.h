...
public:
    ...
    IMPORT_C Int32 putAttr(taf::JceOutputStream &os, const String &key, const String & type_name);
...
#define DO_PUT  {_os->reset(); _os->write(t, 0); return putAttr(*_os, name, getStructName(t));  }    
    ...
    IMPORT_C Int32 getAttr(taf::JceInputStream &is, const String &key, const String & type_name);
...
#define DO_GET \
     ...
     */
    IMPORT_C const JMapWrapper<String, JMapWrapper<String, JArray<Char> > >& getData() const;
