 ...
 */
struct TafUseCoroException : public TafException
{
    TafUseCoroException(const string &buffer) : TafException(buffer){};
    TafUseCoroException(const string &buffer, int err) : TafException(buffer, err){};
    ~TafUseCoroException() throw(){};
};
///////////////////////////////////////////////////////////////////
}
#endif
