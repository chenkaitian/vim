#ifndef __TAF_PROMSISE_BIND_H__
#define __TAF_PROMSISE_BIND_H__
...
namespace promise {
    ...
    bind(Functor functor, const A1& a1)
    {
        ...
        // the original. 
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value,
                      do_not_bind_functions_with_non_const_ref);

        // Do not allow pass raw pointers as the bound argument, because this may cause
        // memory leak. Use promise::unretained(), promise::owned() to specify the memory
        // ownership explicitly.
        TAF_PROMISE_STATIC_ASSERT(!is_raw_pointer<A1>::value, do_not_pass_raw_pointers_as_bound_argument);
    ...
    bind(Functor functor, const A1& a1, const A2& a2)
    {
        ...
        // the original. 
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A2Type>::value,
                      do_not_bind_functions_with_non_const_ref);

        // Do not allow pass raw pointers as the bound argument, because this may cause
        // memory leak. Use promise::unretained(), promise::owned() to specify the memory
        // ownership explicitly.
        TAF_PROMISE_STATIC_ASSERT(!is_raw_pointer<A1>::value
                      && !is_raw_pointer<A2>::value,
    ...
    bind(Functor functor, const A1& a1, const A2& a2, const A3& a3)
    {
        ...
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A2Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A3Type>::value,
                      do_not_bind_functions_with_non_const_ref);
    ...
    bind(Functor functor, const A1& a1, const A2& a2, const A3& a3, const A4& a4)
    {
        ...
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A2Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A3Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A4Type>::value,
                      do_not_bind_functions_with_non_const_ref);
    ...
    bind(Functor functor, const A1& a1, const A2& a2, const A3& a3, const A4& a4, const A5& a5)
    {
        ...
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      ...
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A3Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A4Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A5Type>::value,
                      do_not_bind_functions_with_non_const_ref);
         ...
         const A5& a5, const A6& a6)
    {
        ...
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      ...
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A4Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A5Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A6Type>::value,
                      do_not_bind_functions_with_non_const_ref);
         ...
         const A5& a5, const A6& a6, const A7& a7)
    {
        ...
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      ...
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A5Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A6Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A7Type>::value,
                      do_not_bind_functions_with_non_const_ref);
         ...
         const A5& a5, const A6& a6, const A7& a7, const A8& a8)
    {
        ...
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      ...
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A6Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A7Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A8Type>::value,
                      do_not_bind_functions_with_non_const_ref);
    ...
    bind(Functor functor, const A1& a1, const A2& a2, const A3& a3, const A4& a4, const A5& a5, const A6& a6, const A7& a7, const A8& a8, const A9& a9)
    {
        ...
        TAF_PROMISE_STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value
                      ...
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A7Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A8Type>::value
                      && !is_non_const_reference<typename detail::FunctionTraits<RunType>::A9Type>::value,
                      do_not_bind_functions_with_non_const_ref);
    ...
    template <typename T>
    detail::SharedWrapper<T> shared(const SharedPtr<T>& p)
    { return detail::SharedWrapper<T>(p); }

} // namespace promise

#endif  // __PROMSISE_BIND_H__
