#ifndef __TAF_PROMISE_TEMPLATE_UTIL_H__
#define __TAF_PROMISE_TEMPLATE_UTIL_H__
...
namespace promise 
{
    ...
    struct is_convertible : integral_constant<bool,
		sizeof(detail::ConvertHelper::Test<To>(detail::ConvertHelper::Make<From>())) == sizeof(detail::Yes)> 
	{
    };
...
#endif  // __TAF_PROMISE_TEMPLATE_UTIL_H__
