...
namespace taf 
{
    namespace detail 
	{
        ...
        // TC_FunctorAdapter<> abstracts away the diff syntaxes of calling functions or class methods.
        //
        ...
        // 
        // TC_UnretainedWrapper specifies the caller be responsible for managing the memory
        ...
        // TC_OwnedWrapper specifies the callback be responsible for managing the memory of
        ...
        // TC_SharedWrapper specifies the object is shared by the caller and the callback. It
        ...
        // are ARITY TC_FunctionTraits types.
        template <typename Signature>
