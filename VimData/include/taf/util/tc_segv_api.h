#ifndef __TC_SEGV_API_H__
#define __TC_SEGV_API_H__
...
#define MAX_SEGV_THREAD_NUM 10000
...
typedef struct {
	...
	int32_t iShiftType;// 0 -> shift by size,  1 -> shift by LogCount, 2 -> shift by interval, 3 ->shift by day, 4 -> shift by hour, 5 -> shift by min
	int32_t    iMaxLogNum;
	int32_t    lMaxSize;
	int32_t    lMaxCount;
	int32_t    lLogCount;
